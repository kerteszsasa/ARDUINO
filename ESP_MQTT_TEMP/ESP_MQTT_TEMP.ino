...
//const char* ssid = "idatapublic";
//const char* password = ".itrack.";
const char* ssid = "Diapro Office";
const char* password = "cd1cd2cd3cd4cd5cd6cd7cd8cd";
...
String raw_temp = String(raw, DEC);
  ...
  if (client.connected()){
    ...
    if (client.publish((char*) "sasa", (char*) raw_temp.c_str())) {
